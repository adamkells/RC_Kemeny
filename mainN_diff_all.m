...
% if potential_type==0
%     nodes=[8,8]; % length of vector defines number of clusters
%     [K,Adj]=erdosrenyi_N(nodes,[0.6,0.025]); % this creates a random erdos renyi graph
...
[kemeny_l]=kemeny_boundary(K,INV_K,eq,bb(:,:,1),0,1)
[kemeny_l]=kemeny_boundary(K,INV_K,eq,bb(:,:,2),1,1)
[kemeny_l]=kemeny_boundary(K,INV_K,eq,bb(:,:,2),0,1)
[kemeny_l]=kemeny_boundary(K,INV_K,eq,bb(:,:,1),1,1)
